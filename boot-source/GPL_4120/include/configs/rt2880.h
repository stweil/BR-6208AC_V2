...
#ifdef MT7620_ASIC_BOARD	// EDX SJC
...
#define RALINK_GPIOMODE_UARTF		0x1D
#ifdef SKU11903
	// Output
	#define GPIO_SWITCH_RESET	0
	#define GPIO_POWER_LED		11	//EDX Randall
	#define GPIO_WPS_LED		7	//EDX Randall
	#define GPIO_2_4G_LED		10
	#define GPIO_5G_LED			14
	#define GPIO_USB_LED		14
	#define GPIO_USB1_ENABLE	7
	#define GPIO_USB0_ENABLE	47
	// Input
	#define GPIO_APSWITCH_BUT	12
	#define GPIO_WPS_BUT		1
	#define GPIO_RESET_BUT		2
#elif SKUGLP
	// Output
	#define GPIO_SWITCH_RESET	0
	#define GPIO_POWER_LED		7	//EDX yihong 
	#define GPIO_WPS_LED		11	//EDX yihong
	#define GPIO_2_4G_LED		14
	#define GPIO_5G_LED		10
	//#define GPIO_USB_LED		14
	#define GPIO_USB0_ENABLE	10	//GPIO 50
	#define GPIO_USB1_ENABLE	5	//GPIO 45
	// Input
	#define GPIO_APSWITCH_BUT	12
	
	#define GPIO_WPS_BUT		1
	#define GPIO_RESET_BUT		2
#elif defined(SKU11040)
	#define GPIO_POWER_LED		11
	#define GPIO_USB0_ENABLE		47
	// Input
	#define GPIO_APSWITCH_BUT	14
	#define GPIO_WPS_BUT			2
	#define GPIO_RESET_BUT		6			// GPIO 46
#endif	// SKU11040
