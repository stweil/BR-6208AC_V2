...
int raspi_erase(unsigned int offs, int len)
{
    ...
    #ifdef SKU00020
		RALINK_REG(RT2880_REG_PIO_24_39_DATA) ^= (1 << GPIO_2_4G_LED);	//EDX wireless len on<->off
    #endif
		#ifdef SKU7478
		RALINK_REG(RT2880_REG_PIO_40_71_DATA) ^= (1 << GPIO_2_4G_LED);	//EDX wireless len on<->off
		RALINK_REG(RT2880_REG_PIO_40_71_DATA) ^= (1 << GPIO_5G_LED);	//EDX wireless len on<->off
    #endif
		printf(".");
	}
	printf("\n");
...
#ifdef SKU00020
	RALINK_REG(RT2880_REG_PIO_24_39_DATA) |= (1 << GPIO_2_4G_LED);	//EDX wireless len off
#endif
#ifdef SKU7478
	RALINK_REG(RT2880_REG_PIO_40_71_DATA) |= (1 << GPIO_2_4G_LED);	//EDX wireless len off
	RALINK_REG(RT2880_REG_PIO_40_71_DATA) |= (1 << GPIO_5G_LED);	//EDX wireless len off
#endif
	printf("Done!\n");
	return 0;
}
