...
#if 1 //edx
#define RTPRIV_IOCTL_STAINFO_USER                   (SIOCIWFIRSTPRIV + 0x1D)
#endif
...
#define RTPRIV_IOCTL_GET_APCLI_PROFILE              (SIOCIWFIRSTPRIV + 0x1E) //EDX Randall
//#define RTPRIV_IOCTL_GET_BW              (SIOCIWFIRSTPRIV + 0x1D) //EDX Randall
