...
#endif
#if 1	// EDX SJC
#define EEPROM_DEFAULT_FILE_PATH                     "/etc_ro/wlan/MT7612E_EEPROM.bin"
#else
...
//#define EEPROM_FILE_DIR			"/etc/wlan/"
...
VOID rtmp_ee_flash_getmem_write( IN struct _RTMP_ADAPTER *pAd);
#endif //_E2P_ALL_
//EDX jerry end
