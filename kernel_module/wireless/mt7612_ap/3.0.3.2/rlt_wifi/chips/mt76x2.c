...
static RTMP_REG_PAIR mt76x2_mac_cr_table[] = {
	...
	{0x1384, 0x00001818},
	{0x1358, 0xEDCBA980},
	//EDX patrick add. MTK patch:MT76x2E_LinuxAP_3.0.3.2_DPA_20140718_Tx_Sharping_and_LPDC_optimize_Patch
...
#if 0 //EDX patrick add. MTK patch:MT76x2E_LinuxAP_3.0.3.2_DPA_20140718_Tx_Sharping_and_LPDC_optimize_Patch
	if (IS_MT7602(ad)) {
