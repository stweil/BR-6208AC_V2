...
//#if defined(P2P_SUPPORT) || defined(RT_CFG80211_P2P_SUPPORT)
...
#ifdef APCLI_SUPPORT //20160426 EDX patrick add. MTK patch: Fixed 5g repeater throughput is bad in air environment.
		...
		// }  //20160426 EDX patrick remove. MTK patch: Fixed 5g repeater throughput is bad in air environment.
//#endif /* P2P_SUPPORT || RT_CFG80211_SUPPORT */
		...
		//20160426 EDX patrick add. MTK patch: Fixed 5g repeater throughput is bad in air environment.
		}
		else
		{
...
#endif /* P2P_SUPPORT || RT_CFG80211_P2P_SUPPORT*/
			{
				...
				if(IS_ENTRY_APCLI(pMacEntry))
				{
...
#endif /* MAC_REPEATER_SUPPORT */
					{
						...
						apCliPkt = (PNDIS_PACKET)MATEngineTxHandle(pAd, pPacket, pMacEntry->wdev_idx, pTxBlk->OpMode);
					}
