...
//EDX yihong ,open this function adaptivity can not work.
//#ifdef _ADV_CONTROL_ //EDX patrick
//extern int advControl;
//#endif
...
//	#ifdef _ADV_CONTROL_ //EDX patrick
//	if(advControl & 1){
//		printk("\n@@@ 7612 adaptivtyControl ON !!\n");
//		if(advControl & 4){
//			printk("@@@ 7612 adaptivtyControl Enable ed_monitor!!\n");
//			bEdcca = TRUE;
//		}
//		else{
//			printk("@@@ 7612 adaptivtyControl Disable ed_monitor!!\n");
//			bEdcca = FALSE;
//		}
//	}
//	#endif
...
#ifdef A_BAND_SUPPORT
#ifdef WSC_V2_SUPPORT
//EDX wade wps2 beacon have to include short_slot_time=1 this is a switch 
//EDX wade		&& (pAd->CommonCfg.Channel <= 14)
			&& (pAd->ApCfg.MBSSID[apidx].EdxShortSlotTime) //EDX wade
#endif
#endif /* A_BAND_SUPPORT */
			)
    		(*pCapInfo) |= 0x0400;
