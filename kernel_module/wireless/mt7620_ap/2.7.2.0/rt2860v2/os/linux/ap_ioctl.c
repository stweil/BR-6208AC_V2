...
/* end of modification */
		...
		case RTPRIV_IOCTL_E2P:
			...
			break;
#if 1 //edx
			case RTPRIV_IOCTL_STAINFO_USER:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_STAINFO_USER, 0, NULL, 0);
			break;
#endif
#ifdef DBG
...
//EDX yihong close
#if 1 //EDX Randall
 		case RTPRIV_IOCTL_GET_APCLI_PROFILE:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_APCLI_PROFILE, 0, NULL, 0);
			break;
/*
 		case RTPRIV_IOCTL_GET_BW:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_BW, 0, NULL, 0);
			break;
*/
#endif
		default:
