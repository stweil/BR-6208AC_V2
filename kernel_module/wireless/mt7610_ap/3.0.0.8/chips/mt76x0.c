...
void percentage_delta_pwr(RTMP_ADAPTER *ad) 
{
	...
	*/
	...
	DBGPRINT(RT_DEBUG_ERROR, ("%s::<After> total drop power = %d dBm, TXBE_R4 = 0x%0x\n", 
...
#if 1 // Edimax Wise
int use_memory=0;
UCHAR RtmpMemory[0x400]={0};
UCHAR RtmpMemoryRead(UCHAR *target, ULONG position, ULONG length)
{
	memcpy(target, &RtmpMemory[position], length);
}
#endif
...
)
{
	...
	for(i=0;i<=15;i++)
	{
		RtmpMemoryRead((UCHAR *)&tmp1, (0x2F0 + i*4), sizeof(tmp1));
		RtmpMemoryRead((UCHAR *)&tmp2, (0x2F0 + i*4 + 2), sizeof(tmp1));
		reg_val = (tmp2 << 16) | tmp1;
...
)
{
	...
	RtmpMemoryRead(&RFValue, 0x268, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B0_R39 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK0, RF_R39, RFValue);
	RtmpMemoryRead(&RFValue, 0x26C, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R24 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R24, RFValue);
	RtmpMemoryRead(&RFValue, 0x270, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R39 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R39, RFValue);
	RtmpMemoryRead(&RFValue, 0x274, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R17 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R58, RFValue);
	RtmpMemoryRead(&RFValue, 0x278, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R58 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R58, RFValue);
	RtmpMemoryRead(&RFValue, 0x27C, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R59 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R59, RFValue);
	/* TX group delay + TX IQ */


	RtmpMemoryRead((UCHAR *)&tmp1, 0x280, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x282, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C38 value [%x] \n",reg_val));
	RTMP_IO_WRITE32(pAd, 0x2C38, reg_val);
	/* RX group delay + RX IQ */
	RtmpMemoryRead((UCHAR *)&tmp1, 0x284, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x286, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C60 value [%x] \n",reg_val));
	RTMP_IO_WRITE32(pAd, 0x2C60, reg_val);
	RtmpMemoryRead((UCHAR *)&tmp1, 0x288, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x28A, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C70 value [%x] \n",reg_val));	
	RTMP_IO_WRITE32(pAd, 0x2C70, reg_val);
	/* LOFT cal */
	for(i=0;i<=15;i++)
	{
		RtmpMemoryRead((UCHAR *)&tmp1, (0x28C + i*4), sizeof(tmp1));
		RtmpMemoryRead((UCHAR *)&tmp2, (0x28C + i*4 + 2), sizeof(tmp1));
		reg_val = (tmp2 << 16) | tmp1;
...
)
{
	...
	DBGPRINT(RT_DEBUG_ERROR,("<==== %s() use_memory=%d\n",__FUNCTION__, use_memory));
	/* LC-A band */
	RtmpMemoryRead(&RFValue, 0x204, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B0_R39 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK0, RF_R39, RFValue);
	RtmpMemoryRead(&RFValue, 0x208, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R24 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R24, RFValue);	
	RtmpMemoryRead(&RFValue, 0x20C, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R39 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R39, RFValue);
	RtmpMemoryRead(&RFValue, 0x210, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R17 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R58, RFValue);
	RtmpMemoryRead(&RFValue, 0x214, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R58 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R58, RFValue);
	RtmpMemoryRead(&RFValue, 0x218, sizeof(RFValue));
	DBGPRINT(RT_DEBUG_TRACE,(" B6_R59 value [%x] \n",RFValue));
	rlt_rf_write(pAd, RF_BANK6, RF_R59, RFValue);
	/* TX group delay + TX IQ */
	
	RtmpMemoryRead((UCHAR *)&tmp1, 0x21C, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x21E, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C38 value [%x] \n",reg_val));
	RTMP_IO_WRITE32(pAd, 0x2C38, reg_val);
	/* RX group delay + RX IQ */
	RtmpMemoryRead((UCHAR *)&tmp1, 0x220, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x222, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C60 value [%x] \n",reg_val));
	RTMP_IO_WRITE32(pAd, 0x2C60, reg_val);
	RtmpMemoryRead((UCHAR *)&tmp1, 0x224, sizeof(tmp1));
	RtmpMemoryRead((UCHAR *)&tmp2, 0x226, sizeof(tmp1));
	reg_val = (tmp2 << 16) | tmp1;
	DBGPRINT(RT_DEBUG_TRACE,(" mac 0x2C70 value [%x] \n",reg_val));	
	RTMP_IO_WRITE32(pAd, 0x2C70, reg_val);
	/* LOFT cal */
	for(i=0;i<=15;i++)
	{
		RtmpMemoryRead((UCHAR *)&tmp1, (0x228 + i*4), sizeof(tmp1));
		RtmpMemoryRead((UCHAR *)&tmp2, (0x228 + i*4 + 2), sizeof(tmp1));	
		reg_val = (tmp2 << 16) | tmp1;
	...
	IN BOOLEAN bSave)
{
...
#else // tommy+08282014 to fix the crash issue
	...
	if(doCal2 == 0x10)
	{
		if(use_memory==0)
		{
			RtmpFlashRead((UCHAR *)&RtmpMemory[0], RF_OFFSET + 0x0, 0x400);
			printk("============================ RtmpMemory ============================\n");
			for(doCal1=0; doCal1<0x400; doCal1++)
			{
				if(doCal1%16==0)
					printk("%07x ", doCal1);

				printk("%02x", (UCHAR)RtmpMemory[doCal1]);
	...
	DlListForEachSafe(ch, ch_temp, &pAd->SingleSkuPwrList, CH_POWER, List)
	{
		...
		if (channel == ch->channel)
		{
			...
			for (i = 0; i < SINGLE_SKU_TABLE_OFDM_LENGTH; i++)
			{
				...
				DBGPRINT(RT_DEBUG_TRACE, ("%s ==> rate_delta = %d\n\n", __FUNCTION__, pAd->chipCap.rate_pwr_table.OFDM[i].MCS_Power));
			}
			...
			for (i = 0; i < (SINGLE_SKU_TABLE_HT_LENGTH >> 1); i++)
			{
				...
				DBGPRINT(RT_DEBUG_TRACE, ("%s ==> rate_delta = %d\n\n", __FUNCTION__, pAd->chipCap.rate_pwr_table.HT[i].MCS_Power));
			}
			...
			for (i = 0; i < (SINGLE_SKU_TABLE_VHT_LENGTH >> 1); i++)
			{
				...
				DBGPRINT(RT_DEBUG_TRACE, ("%s ==> rate_delta = %d\n\n", __FUNCTION__, pAd->chipCap.rate_pwr_table.VHT[i].MCS_Power));
			}
