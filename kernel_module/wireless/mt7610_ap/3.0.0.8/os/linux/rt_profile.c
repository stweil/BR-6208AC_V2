...
#else
#include "../../../../net/hw_nat/ra_nat.h" //EDX
#include "../../../../net/hw_nat/frame_engine.h" //EDX
#endif
#endif
...
#ifdef _Buffalo_
		if( Event_flag == IW_STA_LINKUP_EVENT_FLAG || Event_flag == IW_STA_LINKDOWN_EVENT_FLAG )
			pBufPtr = pBuf;
#endif
		pBufPtr[pBufPtr - pBuf] = '\0';
		BufLen = pBufPtr - pBuf;
#ifdef _Buffalo_
		DBGPRINT(RT_DEBUG_OFF,("LOG# %s\n",pBuf));
#endif
