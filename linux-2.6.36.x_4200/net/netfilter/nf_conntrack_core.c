...
//EDX #include "../nat/hw_nat/ra_nat.h"
...
//#define EDX_CONNTRACK
//#ifdef EDX_CONNTRACK
//int nf_conntrack_max_edx;
//int isReservedConntrack(const struct nf_conntrack_tuple * orig, const struct nf_conntrack_tuple * repl)
//{
//	if((orig->src.u3.all[0] & 0x0000ffff) == 0x0000a8c0)
//	{
//		printk( "src=%x %x %x %x\n", orig->src.u3.all[0], orig->src.u3.all[1], orig->src.u3.all[2], orig->src.u3.all[3]);
//		return 1;
//	}
//	else return 0;
//}
...
//#ifdef EDX_CONNTRACK
//	nf_conntrack_max_edx = nf_conntrack_max - 500;

//        if(nf_conntrack_max &&
//                ((atomic_read(&net->ct.count) > nf_conntrack_max_edx))&&
...
//#endif
	...
	if (nf_conntrack_max &&
//#ifdef EDX_CONNTRACK
//	    unlikely(atomic_read(&net->ct.count) > nf_conntrack_max_edx)) {
//#else
