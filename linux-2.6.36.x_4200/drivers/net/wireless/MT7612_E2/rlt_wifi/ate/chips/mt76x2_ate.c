...
*/
	...
	if (!ad->MCUCtrl.power_on) {
		RT28xx_EEPROM_READ16(ad, BT_RCAL_RESULT, value);

		if ((value & 0xff) != 0xff) {
			printk("r-cal result = %d\n", value & 0xff);
	...
	RTMP_IO_READ32(ad, 0x1004, &mac_1004);
	RTMP_IO_WRITE32(ad, 0x1004, 0x0);
	...
	RTMP_IO_WRITE32(ad, 0x1004, mac_1004);
