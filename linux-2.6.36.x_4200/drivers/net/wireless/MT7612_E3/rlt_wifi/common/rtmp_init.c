...
/*	if (Antenna.word == 0xFFFF)*/
	...
	pAd->rf_band_cap = NICGetBandSupported(pAd);
...
#endif /* DOT11_N_SUPPORT */
			pAd->rf_band_cap = RFIC_24GHZ;
		}
		pAd->rf_band_cap = RFIC_24GHZ | RFIC_5GHZ;
	}
	else
	{
			pAd->rf_band_cap = RFIC_24GHZ;
...
#ifdef RT65xx
	// TODO: shiang-6590, for 8592 now we have tx-status report packet from hardware!!, but we still need this to check UAPSD info!!
//	if (IS_RT65XX(pAd))
//		return;
#endif /* RT65xx */
