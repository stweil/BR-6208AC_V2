...
unsigned long wmcodec_reg_data[55];
...
//	if(AIn > 0)
	{
		...
		wmcodec_write(ADCLPATH, ADCLPATH_LMN1|ADCLPATH_LMIC2B); /* ADCLPATH(0x20)=>(0x108)*/
		wmcodec_write(ADCRPATH, ADCRPATH_RMN1|ADCRPATH_RMIC2B); /* ADCRPATH(0x21)=>(0x108)*/
