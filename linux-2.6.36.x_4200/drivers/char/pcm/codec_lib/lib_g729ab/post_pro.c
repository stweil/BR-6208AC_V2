...
{
  pg729dec->ppost_pro->y2_hi = 0;
  pg729dec->ppost_pro->y2_lo = 0;
  pg729dec->ppost_pro->y1_hi = 0;
  pg729dec->ppost_pro->y1_lo = 0;
  pg729dec->ppost_pro->x0   = 0;
  pg729dec->ppost_pro->x1   = 0;
}
