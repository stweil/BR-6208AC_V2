...
#define	HWCONFIG_SIZE		0x10000
#define EDX_MTD_KERN_PART_SIZE          (MTD_KERN_PART_SIZE - NVRAM_SIZE - HWCONFIG_SIZE)
//EDX end
...
//EDX jerry end
		...
		offset:         MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_FACTORY_PART_SIZE + 0x20000,

	}, {

	//EDX Robert Add, Support new SPEC use. E.g. Save *.ovpn file.
		name:           "FreeSpace",
		size:           0x20000,
		offset:         MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_FACTORY_PART_SIZE + 0x20000 + CONFIG_MTD_KERNEL_PART_SIZ + MTD_ROOTFS_PART_SIZE,
	/*
...
//EDX start
#define	MTD_EDX_ROOTFS_SIZE		(MTD_ROOTFS_PART_SIZE - NVRAM_SIZE - HWCONFIG_SIZE) //EDX
		name:           "RootFS",            
		size:           MTD_EDX_ROOTFS_SIZE, //EDX
		offset:         MTDPART_OFS_APPEND,
	}, {
                name:           "hwconfig",
                size:           HWCONFIG_SIZE,
		...
		name:           "Uimage",
		size:           MTD_KERN_PART_SIZE + MTD_EDX_ROOTFS_SIZE,
		offset:         MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_FACTORY_PART_SIZE + NVRAM_SIZE,
//EDX end
#ifdef CONFIG_ROOTFS_IN_FLASH_NO_PADDING
        }, {
                name:           "Kernel_RootFS",
...
//EDX start
	...
	,{
                name:           "LANGUAGE_PACK",
                size:           _LANGUAGE_PACK_ * 0x10000,
                offset:         0x800000 - _LANGUAGE_PACK_ * 0x10000,
	}
#endif
//EDX end
};

#endif //EDX yihong end
