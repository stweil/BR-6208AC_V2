...
<input type="hidden" value="1" id="Aband" name="Aband">
...
<div align="left">
	<form method="post" action="goform/formUpload" enctype="multipart/form-data" name="upload">
		<table border="1" width="550" cellspacing="0" cellpadding="0" align=center>
			...
			<tr class="table2">
				<td width=30% align=right><font size=2><script>dw(Model);</script>&nbsp;</font></td>
				<td width=70% colspan="2"><font size=2>&nbsp;RE11S</font></td>
			</tr>
			<tr class="table2">
				<td width=30% align=right><font size=2><script>dw(RuntimeCodeVersion);</script>&nbsp;</font></td>
