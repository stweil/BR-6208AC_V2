...
var defaultKeyIdTbl=<%getInfo("defaultKeyIdAll");%>;
...
var hidSSID = <%getVar("hiddenSSID1","","");%>;
...
<blockquote>
	...
	<form action="/goform/formWlEnableSwitch" method="POST" name="EnableSwitch">
		<input type="hidden" value="1" name="mssidSelect">
		<input type="hidden" value="" name="wlDisabled">
		<input type="hidden" value="/guest_wireless_basic.asp" name="submit-url">
	</form>
