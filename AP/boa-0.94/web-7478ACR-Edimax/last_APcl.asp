...
function setTableWidth()
{
	if(isRestDefault == 1){
		...
		document.all.table1width.className="tablewidth"+languIndex;

		document.all.tableLwidth.className="TypeLtable"+languIndex;
		document.all.tableMwidth.className="TypeMtable"+languIndex;
		document.all.tableRwidth.className="TypeRtable"+languIndex;

		document.all.tableL1width.className="TypeLtable"+languIndex;
		document.all.tableM1width.className="TypeMtable"+languIndex;
		
		document.all.tableL2width.className="TypeLtable"+languIndex;
		document.all.tableM2width.className="TypeMtable"+languIndex;
	}
}
</script>
...
<td align="center">
	...
	<span id="setupId" style="display:none">
		...
		<table border="0" style="height:50px;" id="table1width" class="table2width0" align="center">
			<tr>
				<td align="left" style="font-size:16px;font-family:Calibri,Arial,Microsoft JhengHei; line-height:25px;"><script>dw(APcl_lastinfo)</script>
			</tr>
		</table>
	</span>
	...
	<span id="APcl_info" style="display:none">
		<table border="0" style="height:100px;width:700px" align="center">
			<tr>
				...
				<td align="left" id="tableMwidth" class="tableMwidth0">&nbsp;</td>	
				<td align="left" id="tableRwidth" class="tableRwidth0">&nbsp;</td>	
