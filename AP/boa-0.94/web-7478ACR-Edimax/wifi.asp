...
function setTableWidth()
{
	...
	document.getElementById('infotablewidth').className="infotablewidth"+languIndex;
	document.getElementById('settablewidth').className="settablewidth"+languIndex;
	document.getElementById('settable1width').className="settablewidth"+languIndex;
	document.getElementById('settable2width').className="settablewidth"+languIndex;
	document.getElementById('settable3width').className="settablewidth"+languIndex;

	document.getElementById('leftwidth').className="leftwidth"+languIndex;
	document.getElementById('rightwidth').className="rightwidth"+languIndex;
	document.getElementById('left1width').className="leftwidth"+languIndex;
	document.getElementById('right1width').className="rightwidth"+languIndex;

	document.getElementById('at8rightwidth').className="at8rightwidth"+languIndex;
	document.getElementById('at8leftwidth').className="at8leftwidth"+languIndex;
	document.getElementById('at8right1width').className="at8rightwidth"+languIndex;
	document.getElementById('at8left1width').className="at8leftwidth"+languIndex;
