...
<input type="hidden" value="3" name="wizmode_value">
...
<td align="center">
	...
	<table border="0" style="height:156px;width:780px" align="center">
		<tr>
			<td align="center" class="Arial_16">
				<br>
					<img src="graphics/Range-extender-2-1.gif" STYLE="cursor:pointer" width="567" height="156" border="0" name="Image3" onClick="">
			</td>
		</tr>
	</table>
	...
	<table border="0" style="height:191px;" id="tablewidth" class="tablewidth0" align="center" >
		<tr>
			<td align="left"><span class="Arial_16" style="line-height:25px;"><script>dw(APcl_info)</script></span></td>
		</tr>
	</table>
