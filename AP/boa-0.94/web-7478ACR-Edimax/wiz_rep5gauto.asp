...
var hiddenssid2g = <%getVar("hiddenSSID","","");%>;
...
function ButtonDoneEnable() {
	...
	if (rep_enable2g == "1") { //if 2.4G enable, 5g PW will the same with 2.4G.
		GetIDType("passwordValue").value = pskValueTbl[0];
	}
}
...
function setHideSSID()
{
	...
	if (document.formAutoConnect.HideSSIDclick2g.checked==true){
		GetIDType("hiddenSSID2g").value = "yes";
	}else{
		GetIDType("hiddenSSID2g").value = "no";
	}
}
function setAutoKey()
{
	...
	<table border="0" style="height:16px;width:780px" align="center" cellspacing="0">
		<tr>
			<td align="center"><span class="Arial_16" style="font-weight:bold;">
				5GHz&nbsp;<script>dw(WirelessSiteSurvey)</script><p></span>
			</td>
		</tr>
	</table>
	...
	<table border="0" style="height:80px;width:700px" align="center">
		<tr>
			...
			<td style="width:390px">
			  <input type="text" id="DUTssid2g" name="DUTssid2g" size="23" maxlength="32" value="" class="Arial_16">
			  &nbsp;
			  <script>
				  if(hiddenssid2g==1)
					  document.write('<input type="checkbox" onclick="setHideSSID();" name="HideSSIDclick2g" class="Arial_16" checked>');   
				  else
					  document.write('<input type="checkbox" onclick="setHideSSID();" name="HideSSIDclick2g" class="Arial_16" >');		
			  </script>
...
<table border="0" style="height:28px;width:780px" align="center" cellspacing="0">
	...
	<table border="0" style="height:45px;width:780px" align="center" cellspacing="0">
		<tr><td></td></tr>
	</table>
...
<form action="/goform/formiNICbasic" method="POST" name="connect">
	...
	<input type="hidden" value="no" name="hiddenSSID2g" id="hiddenSSID2g">
	<input type="hidden" value="" name="repeaterSSID" id="repeaterSSID">
	<input type="hidden" value="" name="ssid" id="ssid">
	<input type="hidden" value="" name="ssid2g" id="ssid2g">
