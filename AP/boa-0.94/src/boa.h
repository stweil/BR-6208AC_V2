...
/* $Id: boa.h,v 1.1 2010/02/09 13:53:03 bradhuang Exp $*/
...
#define open_logs() {}
#define log_access(req) {}
#define log_error_doc(req) {}
#define boa_perror(req, message) {}
#define log_error_time() {}
#define log_error(mesg) {}
#ifdef HAVE_FUNC
#define log_error_mesg(file, line, func, mesg) {}
#define log_error_mesg_fatal(file, line, func, mesg) {}
#else
#define log_error_mesg(file, line, mesg) {}
