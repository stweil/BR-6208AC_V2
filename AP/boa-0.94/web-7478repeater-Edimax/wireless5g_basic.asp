		...
		for (i=0; i<=6; i++)
		{
			if (document.wlanSetup.apMode.value == i)
			{
				...
				/*if((wizMode==1) && ( typeof(_VLANTAG_) != "undefined"))
					document.getElementById('vlanId').style.display = showvlan[i];*/
...
function saveChanges(rebootFlag)
{
	...
	with(document.wlanSetup) {
		...
		if (document.wlanSetup.WLDisabled.checked != true){
			...
			if(wpsConfigType == 0){
				if((ssid.value != ssidTbl[0]) || (strMethod != 0)){  // if SSID changed, DUT is config
					wpsStatus.value="1";
				}
			}
...
<form action="/goform/formiNICEnableSwitch" method="POST" name="DisableSwitch">
	<input type="hidden" value="" name="wlDisabled">
	<input type="hidden" value="/wireless5g_basic.asp" name="submit-url">
</form>	
		...
		<legend><script>dw(basicsetting)</script></legend>
						...
						<tr>
							...
							<td><div class="itemText2-len">
									...
									<select name="apMode" onChange="displayObj(1, 0);">
											<script>
												var modeTbl = new Array(showText(apmode0),showText(apmode1),showText(apmode2),showText(apmode3),
                                                showText(apmode4),showText(apmode5),showText(apmode6));
												for ( i=0; i<=6; i++)
												{
													if((i==0)||(i==5))
													{
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(showClients)+'" name="selSurvey5g" onClick="open_Window(\'/wlsurveyonly5g.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(wlSiteSurvey)</script></div></td>
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(selSiteSurvey)+'" name="selSurvey_rp" onClick=open_Window("/wlsurvey5g.asp") class="ui-button-nolimit">');</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getiNICInfo("wlLinkMac2"); %>" name="wlLinkMac2"></div></td>
						</tr>
						<tr>
							<td><div class="itemText-len"><script>dw(macAddr)</script>&ensp;3</div></td>
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getiNICInfo("wlLinkMac3"); %>" name="wlLinkMac3"></div></td>
						</tr>
						<tr>
							<td><div class="itemText-len"><script>dw(macAddr)</script>&ensp;4</div></td>
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getiNICInfo("wlLinkMac4"); %>" name="wlLinkMac4"></div></td>
						</tr>
					</table>
					</span>
