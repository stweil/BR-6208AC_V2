...
{
	wepValueAll = <% getInfo("wepValueAll");%>;
...
function init()
{
	...
	with(document.wlanSetup) {
		...
		if(wlsw)
		{
			...
			band.disabled = true;
			ssid.disabled = true;
			/*if((wizMode==1) && ( typeof(_VLANTAG_) != "undefined"))
			...
			selSurvey2g.disabled = true;
			selSurvey.disabled = true;
			selSurvey_rp.disabled = true;
			repeaterSSID.disabled = true;
			wlLinkMac1.disabled = true;
			wlLinkMac2.disabled = true;
			wlLinkMac3.disabled = true;
			wlLinkMac4.disabled = true;
			SetSecurity3.disabled = true;
			SetSecurity4.disabled = true;
			SetSecurity5.disabled = true;

			method1.disabled = true;
			method2.disabled = true;
			method3.disabled = true;
			length.disabled = true;
			format.disabled = true;
			key1.disabled = true;
			key1_1.disabled = true;

			document.getElementById('keyhidewep').disabled = true;
			document.getElementById('keyhidewep1').disabled = true;
			document.getElementById('wpaCipher1_tkip').disabled = true;
			document.getElementById('wpaCipher1_aes').disabled = true;
			document.getElementById('wpaCipher1_mixed').disabled = true;
			document.getElementById('wpaCipher2_tkip').disabled = true;
			document.getElementById('wpaCipher2_aes').disabled = true;
			document.getElementById('wpaCipher3_aes').disabled = true;

			pskFormat.disabled = true;
			pskValue.disabled = true;
			pskValue_1.disabled = true;

			document.getElementById('keyhide').disabled = true;
			document.getElementById('keyhide1').disabled = true;
			enRadius.disabled = true;
			radiusIP.disabled = true;
			radiusPort.disabled = true;
			radiusPass.disabled = true;
		}
	}
}
...
<blockquote>
	...
	<form action="/goform/formWlEnableSwitch" method="POST" name="DisableSwitch">
		<input type="hidden" value="" name="wlDisabled">
		<input type="hidden" value="/wireless_basic.asp" name="submit-url">
	</form>
	...
	<fieldset name="wlanSetup_fieldset" id="wlanSetup_fieldset">
		<legend><script>dw(basicsetting)</script></legend>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td colspan="2"><input type="checkbox" name="WLDisabled" value="no" <%getVar("wlanDisabled","1","checked");%> onclick="WlSwitch()">&nbsp;<span class="itemText"><script>dw(disable)</script>&ensp;<script>dw(Wireless)</script></span></td>
						</tr>

						<tr>
							<td><div class="itemText-len"><script>dw(mode)</script></div></td>
							<td><div class="itemText2-len">
									<!--
									<select name="apMode" onChange="displayObj(1, 0);" >
											<script>

												var modeTbl = new Array(showText(apmode0),showText(apmode1),showText(apmode2),showText(apmode3),showText(apmode4),showText(apmode5),showText(apmode6));
												for ( i=0; i<=6; i++)
												{
													if((i==0) || (i==5))
													{
										...
										<span class="choose-itemText ">
											<script>dw(apmode0)</script>	
											<input type="hidden" name="apMode" value="0">
										</span>
							</div></td>
						</tr>
						<tr>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(showClients)+'" name="selSurvey2g" onClick="open_Window(\'/wlsurveyonly.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><script>document.write('<input type=button value="'+showText(showClients)+'" name="showClients" onClick="open_Window(\'/wlClient.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(wlSiteSurvey)</script></div></td>
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(selSiteSurvey)+'" name="selSurvey" onClick="open_Window(\'/wlsurvey.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><input type="text" name="repeaterSSID" size="25" maxlength="32" value="<% getInfo("repeaterSSID"); %>"></div></td>
						</tr>
					</table>
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(wlSiteSurvey)</script></div></td>
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(selSiteSurvey)+'" name="selSurvey_rp" onClick=open_Window("/wlsurvey.asp") class="ui-button-nolimit">');</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getInfo("wlLinkMac1"); %>" name="wlLinkMac1"></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(macAddr)</script>&ensp;2</div></td>
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getInfo("wlLinkMac2"); %>" name="wlLinkMac2"></div></td>
						</tr>
						<tr>
							<td><div class="itemText-len"><script>dw(macAddr)</script>&ensp;3</div></td>
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getInfo("wlLinkMac3"); %>" name="wlLinkMac3"></div></td>
						</tr>
						<tr>
							<td><div class="itemText-len"><script>dw(macAddr)</script>&ensp;4</div></td>
							<td><div class="itemText2-len"><input type="text" size="15" maxlength="12" value="<% getInfo("wlLinkMac4"); %>" name="wlLinkMac4"></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(SetSecurity)+'" name="SetSecurity3" onClick="open_Window(\'/wlWDS3_key.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(SetSecurity)</script></div></td>
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(SetSecurity)+'" name="SetSecurity4" onClick="open_Window(\'/wlWDS4_key.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					</span>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							<td><div class="itemText-len"><script>dw(SetSecurity)</script></div></td>
							<td><div class="itemText2-len"><script>document.write('<input type="button" value="'+showText(SetSecurity)+'" name="SetSecurity5" onClick="open_Window(\'/wlWDS5_key.asp\')" class="ui-button-nolimit">')</script></div></td>
						</tr>
					</table>
					</span>
		...
		<legend><script>dw(Wireless)</script>&ensp;<script>dw(Security)</script></legend>
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						<tr>
							...
							<td id="noRADIUS" style="display:none"><div class="itemText2-len">
								<select size="1" name="method2" onChange="displayObj(2, 2);">
									<script>
										for ( i=0; i<4; i++)
										{
											if ( i == methodVal)
							...
							<td id="PSKonly" style="display:none"><div class="itemText2-len">
								<select size="1" name="method3" onChange="displayObj(2, 3);">
									<script>
										for ( i=0; i<4; i++)
										{
											if ( i == methodVal)
											{
												if (i==2 || i==0) document.write('<option selected value="'+i+'">'+modeTbl[i]+'</option>');
											}
											else
											{
												if (i==2 || i==0) document.write('<option value="'+i+'">'+modeTbl[i]+'</option>');
											}
										}
									</script>
								</select>
						...
						<tr>
							...
							<td><div class="itemText2-len">
								...
								<div id="wepdisplay" style="display:none">
									...
									<input type="checkbox" ame="hidewep" value="OFF" onclick="hideWepvalue(1);" id="keyhidewep1"><span class="choose-itemText"><script>dw(Hide)</script></span>
								</div>
							</div></td>
						</tr>
					...
					<input type="hidden" name="wpaCipher" value="<%getVar("wpaCipher","","");%>;">
						...
						<tr>
							...
							<td id="normal" style="display:block"><div class="itemText2-len"><span class="choose-itemText">
								<script>
									...
									document.write('<input type="radio" id="wpaCipher1_tkip" name="wpaCipher1" value="1" onclick="setwpamode(1,1);" <%getVar("wpaCipher","1","checked");%>>'+showText(WPA_TKIP)+'&nbsp;&nbsp;');
									document.write('<input type="radio" id="wpaCipher1_aes" name="wpaCipher1" value="2"  onclick="setwpamode(1,2);" <%getVar("wpaCipher","2","checked");%>>'+showText(WPA2_AES)+'&nbsp;&nbsp;');
									document.write('<input type="radio" id="wpaCipher1_mixed" name="wpaCipher1" value="3"  onclick="setwpamode(1,3);" <%getVar("wpaCipher","3","checked");%>>'+showText(WPA2_Mixed));
								</script>
							</span></div></td>

							<td id="noMixed" style="display:none"><div class="itemText2-len"><span class="choose-itemText">
							<script>
								document.write('<input type="radio" id="wpaCipher2_tkip" name="wpaCipher2" value="1"  onclick="setwpamode(2,1);" <%getVar("wpaCipher","1","checked");%>>'+showText(WPA_TKIP)+'&nbsp;&nbsp;');
								document.write('<input type="radio" id="wpaCipher2_aes" name="wpaCipher2" value="2"  onclick="setwpamode(2,2);" <%getVar("wpaCipher","2","checked");%>>'+showText(WPA2_AES)+'&nbsp;&nbsp;');
							</script>
							</span></div></td>

							<td id="AESonly" style="display:none"><div class="itemText2-len"><span class="choose-itemText">
							<script>
								document.write('<input type="radio" id="wpaCipher3_aes" name="wpaCipher3" value="2"  onclick="setwpamode(3,2);" <%getVar("wpaCipher","3","checked");%>>'+showText(WPA2_AES)+'&nbsp;&nbsp;');
							</script>
							</span></div></td>
						...
						<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700"> 
							<tr>
								<td><div class="itemText-len">
									<input type="checkbox" <%getVar("enable1X","1","checked");%> name="enRadius" value="ON" onClick="displayObj(1, 0);">&nbsp;&nbsp;<script>dw(Enable_8021x)</script>
								</div></td>	
								<td><div class="itemText2-len">
								</div></td>
							</tr>
...
<script>
	wlEncrypt_displayObj(bandVal-1);
	displayObj(1, 0);	
