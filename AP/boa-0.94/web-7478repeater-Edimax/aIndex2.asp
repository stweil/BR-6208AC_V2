...
function changeMode()
{
	...
	document.check.submiturl.value = "/wiz_select.asp";
	document.check.submit();
}
function goNext()
{
	document.check.ModeSelect.value = "Repeater";
...
<td align="center">
	...
	<table border="0" align="center" style="height:90px;width:700px">
		<tr><td align="right" class="Arial_16"><script>dw(repeatermode)</script></td></tr>
	</table>

	<table border="0" align="center" style="height:128px;" id="tablewidth" class="tablewidth0">
		<tr><td align="center" class="Arial_16" style="text-align:left;"><script>dw(DefaultIsExtender)</script></td></tr>
	</table>

	<table border="0" align="center" style="height:250px;width:600px">
		<tr>
			<td align="center">
		 		<img src="graphics/Range-extender-1.gif" width="600" height="250" border="0">
			</td>
		</tr>
	</table>
	...
	<table border="0" style="height:28px;width:780px" align="center">
		<tr>
			<script>
				...
				document.write('&nbsp;&nbsp;<input type="button" value="'+showText(YesNeedEx)+'" name="close" onClick="goNext();" class="button_IQ3" style="cursor:pointer">');
				document.write('</td>');
			</script>
		</tr>
	</table>
