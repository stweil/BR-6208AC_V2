...
var wlanAcNum = <%getVar("wlanAcNum","","");%>;
		...
		<fieldset name="dynamicip_fieldset" id="dynamicip_fieldset">
			<legend><script>dw(AccessControl)</script></legend>
					<form action="/goform/formWlAc" method="POST" name="formWlAcEnabled">
							...
							<input type="hidden" value="/wireless_access.asp" name="submit-url">
		        ...
		        <input type="hidden" value="" name="isApply">
					...
					<form action="/goform/formWlAc" method="POST" name="formFilterAdd">
							...
							<table width="700" border="0" cellpadding="2" cellspacing="2" align="center">
									<tr>
										<td colspan="5" style="text-align:left; padding-left:20px;"><input type="checkbox" name="wlanAcEnabled" value="ON" <%getVar("wlanAcEnabled","1","checked");%> onclick="wlanAcSwitch()"><span class="itemText"><script>dw(EnableWlAccessControl)</script></span></td>
									</tr>
									<tr>
										<td colspan="5">&nbsp;</td>
									</tr>
									<tr>
										...
										<input type="hidden" value="/wireless_access.asp" name="submit-url"></td>
										</tr>
										<tr>
											<td colspan="5">&nbsp;</td>
										</tr>
			...
			<form action="/goform/formWlAc" method="POST" name="formWlAcApply">
