		...
		<fieldset name="LANIP_fieldset" id="LANIP_fieldset">
			<legend><script>dw(LANIP)</script></legend>
				...
				<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
					...
					<tr>
						<td><div class="itemText-len"><script>dw(wireSpanTree)</script></div></td>
						<td><div class="itemText2-len">
							<select size="1" name="stp">
								<script>
									var spanTreemode = <%getVar("stp","","");%>;
									if(!spanTreemode)
									{
										document.write('<option selected value="0">'+showText(disable)+'</option>');
										document.write('<option value="1">'+showText(enable)+'</option>');
									}
									else
									{
										document.write('<option value="0">'+showText(disable)+'</option>');
										document.write('<option selected value="1">'+showText(enable)+'</option>');
									}
								</script>
							</select>
						</div></td>
