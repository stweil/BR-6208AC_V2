...
function getCookie(c_name)
{
   ...
   else
  {
      ...
      var language = navigator.browserLanguage;
		...
		else if (language.toLowerCase().indexOf('de') > -1) stype=1;
		...
		else if (language.toLowerCase().indexOf('ua') > -1) stype=12;
		else if (language.toLowerCase().indexOf('tw') > -1) stype=13;
		else if (language.toLowerCase().indexOf('cn') > -1) stype=14;
		else stype=0;
...
function DialogBox(title)
{
	...
	dialogBox.setAttribute("id", "dialogBox");
 	...
 	//document.write("<center><IMG HEIGHT=24 WIDTH=24 SRC='wait.gif'>")

	var dialogBoxContents = "";
	dialogBoxContents += "<table width=\"100%\" border=\"0\">";
	dialogBoxContents += "	<tr>";
	dialogBoxContents += "		<td align=\"center\"><a style=\"font-size:1em;\">"+title+"</a></td>";
	dialogBoxContents += "	</tr>";
	dialogBoxContents += "	<tr>";
	dialogBoxContents += "		<td align=\"center\"><img height=\"24\" width=\"24\" src=\"graphics/wait.gif\" id=\"wait_gif\"></td>";
	dialogBoxContents += "	</tr>";
...
function getListWidth(input)
{
	//default list:190px main:834px
	var width_value=190;
	if (stype == 1)       {width_value=220;}
	else if (stype == 2)  {width_value=234;}
	else if (stype == 3)  {width_value=222;}
	else if (stype == 6)  {width_value=232;}
	else if (stype == 7)  {width_value=224;}
	else if (stype == 8)  {width_value=248;}
	else if (stype == 9)  {width_value=192;}
	else if (stype == 10) {width_value=250;}
	else if (stype == 11) {width_value=202;}
	else if (stype == 12) {width_value=248;}
	else                  {width_value=190;}
	return width_value;
}
var lframe_list_width = getListWidth(stype);
