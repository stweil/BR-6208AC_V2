...
function sub_list_click(cur_subitem, cur_item, total_sub_item) {
		...
		if((select_subItem != 11) && (befor_selectItem != 11)){   // init selected subitem befor click new subitem, 10 is default value
...
<td valign="top">
	...
	<div id="Internet_1" >
				...
				<td nowrap="nowrap" width="15"></td>
					<td nowrap="nowrap">
						<a href='inter_wan.asp' target='main'>
							<span class="sublist" id="subl-ist-Title3_1" onClick="sub_list_click(1,3,3);" >
				...
				<td nowrap="nowrap" width="15"></td>
					<td nowrap="nowrap">
						<a href="inter_ddns.asp" target="main">
							<span class="sublist" id="subl-ist-Title3_2" onClick="sub_list_click(2,3,3);" >
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list3_3" onmouseout="sub_color_change_mouseout(3,3);" onmouseover="sub_color_change_mouseover(3,3);">
			<tr>
				<td nowrap="nowrap" width="15"></td>
					<td nowrap="nowrap">
						<a href="inter_dnsproxy.asp" target="main">
							<span class="sublist" id="subl-ist-Title3_3" onClick="sub_list_click(3,3,3);" >
								<script>dw(DNSPROXY)</script>
							</span>
						</a>
					</td>
			</tr>
		...
		<table class="last_subitemBorder" width="100%" border="0" cellspacing="0" cellpadding="3" id="list3_4" onmouseout="sub_color_change_mouseout(4,3);" onmouseover="sub_color_change_mouseover(4,3);">
			<tr>
				<td nowrap="nowrap" width="15"></td>
					<td nowrap="nowrap">
						<a href="inter_vpn.asp" target="main">
							<span class="sublist" id="subl-ist-Title3_4" onClick="sub_list_click(4,3,4);" >
								<script>dw(VPN)</script>&nbsp;<script>dw(Server)</script>
							</span>
						</a>
					</td>
			</tr>
	...
	<div id="Advance_1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list9_4" onClick="sub_list_click(4,9,8);" onmouseout="sub_color_change_mouseout(4,9);" onmouseover="sub_color_change_mouseover(4,9);">
			<tr>
				<td nowrap="nowrap" width="15"></td>
				<td nowrap="nowrap"><a href='adv_wireless.asp' target='main'>
					<span class="sublist" id="subl-ist-Title9_4">2.4<script>dw(GHz)</script>&nbsp;<script>dw(Wireless)</script></span></a>
				</td>
			</tr>
		</table>
	...
	<div id="Administration_1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list10_5" onmouseout="sub_color_change_mouseout(5,10);" onmouseover="sub_color_change_mouseover(5,10);">
			<tr>
				<td nowrap="nowrap" width="15"></td>
				<td nowrap="nowrap" id="IEBrowser"><a href='admin_upgradeIE.asp' target='main'>
					<span class="sublist" onClick="sub_list_click(5,10,9);" id="subl-ist-Title10_5"><script>dw(Upgrade)</script></span></a>
				</td>
				<td nowrap="nowrap" id="OtherBrowser"><a href='admin_upgrade.asp' target='main'>
					<span class="sublist" onClick="sub_list_click(5,10,9);" id="subl-ist-Title10_5"><script>dw(Upgrade)</script></span></a>
				</td>				
			</tr>
		</table>
