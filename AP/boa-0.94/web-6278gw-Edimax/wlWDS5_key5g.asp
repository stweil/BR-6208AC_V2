...
var methodVal = <%getiNICVar("wdsEncrypt","","");%>;
var opMode = <%getVar("opMode","","");%>;
var APSecMode = <%getiNICVar("secMode","","");%>;
...
<p align="center">
	<br>
  <span class="tiltleText"><script>dw(apmode5)</script>&nbsp;<script>dw(SecuritySetting)</script></span>
  <!--<br>
  <br>
  ...
  <br>
	...
	<form action="/goform/formiNICWdsEncrypt" method=POST name="formWdsEncrypt">
				...
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;"><span class="choose-itemText">
						<script>
							...
							var wdswpaCipher5G = <%getiNICVar("wdsWpaCipher","","");%>;
							if(wpaCipher5G == 1)
				...
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;">
						<select size="1" name="wdsPskFormat">
							<script>	
								var wdsPskFormat = <%getiNICVar("wdsPskFormat","","");%>;				
								var pskFormat = <%getiNICVar("pskFormat","","");%>;
								//if(wdsPskFormat == 0)
								if(pskFormat == 0)
								{
...
<!--====================================================================== end =======================================================================-->
			...
			<table align="center" border="0" Cellspacing="0" width="450">
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;">	
						<script>
							var wdsPskValue =	<%getiNICInfo("wdsPskValue");%>;
			...
			<input type="hidden" value="/wlWDS5_key5g.asp" name="submit-url">
	</form>
