...
function setTableWidth()
{
	...
	document.getElementById('infotable').className="tablewidth"+stype;


	document.getElementById('tableLwidth').className="TypeLtable"+stype;
	document.getElementById('tableMwidth').className="TypeMtable"+stype;

	if((wizMode != 2) || ((wizMode == 2) && (repenable2g=="1")))
		document.getElementById('tableRwidth').className="TypeRtable"+stype;

	document.getElementById('tableL1width').className="TypeLtable"+stype;
	document.getElementById('tableM1width').className="TypeMtable"+stype;
	document.getElementById('tableR1width').className="TypeRtable"+stype;
	
	document.getElementById('tableL2width').className="TypeLtable"+stype;
	document.getElementById('tableM2width').className="TypeMtable"+stype;
	document.getElementById('tableR2width').className="TypeRtable"+stype;

	document.getElementById('tableL3width').className="TypeLtable"+stype;
	document.getElementById('tableM3width').className="TypeMtable"+stype;
	document.getElementById('tableR3width').className="TypeRtable"+stype;

	document.getElementById('tableL4width').className="TypeLtable"+stype;
	document.getElementById('tableM4width').className="TypeMtable"+stype;
	document.getElementById('tableR4width').className="TypeRtable"+stype;

	document.getElementById('tableL5width').className="TypeLtable"+stype;
	document.getElementById('tableM5width').className="TypeMtable"+stype;
	document.getElementById('tableR5width').className="TypeRtable"+stype;

	document.getElementById('tableL6width').className="TypeLtable"+stype;
	document.getElementById('tableM6width').className="TypeMtable"+stype;
	document.getElementById('tableR6width').className="TypeRtable"+stype;
}
</script>
<style type="text/css">
