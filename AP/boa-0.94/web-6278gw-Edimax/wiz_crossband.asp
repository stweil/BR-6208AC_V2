...
function setTableWidth()
{
	//if (rep_enable2g == "1" && rep_enable5g == "1"){
		if(rep_EnableCrossBand == "-1")
			document.crossBand.EnableCross.checked = false; /* if default */
		else{
			if(rep_EnableCrossBand == "1")
...
<td align="center">
	...
	<script>
	if (rep_enable2g == "1" && rep_enable5g == "1")
		document.write('<img src="graphics/cross_band.gif" STYLE="cursor:pointer" width="570" height="230" border="0">');
	else if (rep_enable2g == "1" && rep_enable5g == "0")
		document.write('<img src="graphics/cross_band-01.png" STYLE="cursor:pointer" width="570" height="160" border="0">');
	else
		document.write('<img src="graphics/cross_band-02.png" STYLE="cursor:pointer" width="570" height="160" border="0">');
	</script>
	</td>
	</tr>
	</table>
