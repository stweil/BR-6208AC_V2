		...
		if (select == "sel"+i) {
			...
			if(wizmode==2){ //REPEATER
				...
				if(rep_EnableCrossBand == "1")
					parent.document.forms['formAutoConnect'].DUTssid.value = document.forms['formiNICSiteSurvey'].elements['ssid'+i].value.substr(0,28)+"_2EX";
				else
					parent.document.forms['formAutoConnect'].DUTssid.value = document.forms['formiNICSiteSurvey'].elements['ssid'+i].value.substr(0,28)+"_5EX";
