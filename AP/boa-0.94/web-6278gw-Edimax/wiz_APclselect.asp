...
function init()
{
	/*if (iqsetup_finish != 0){
		if (APcl_enable5g=="1"){
			document.APcl_mode.enable5g.checked = true;
			document.APcl_mode.enable2g.checked = false;
		}
		else{
			document.APcl_mode.enable5g.checked = false;
			document.APcl_mode.enable2g.checked = true;	
		}
	}
	else{*/
		document.APcl_mode.enable5g.checked = false;
...
function goBack()
{
	window.location.assign("/wiz_APcl.asp");
}
function goNext()
{
	if (document.APcl_mode.enable5g.checked == true)
		document.APcl_mode.APcl_enable5g.value = "1";
	else
		document.APcl_mode.APcl_enable5g.value = "0";	

	if (document.APcl_mode.enable2g.checked == true)
		document.APcl_mode.APcl_enable2g.value = "1";	
	else
		document.APcl_mode.APcl_enable2g.value = "0";

	document.APcl_mode.submiturl.value = "/wiz_APclredirect.asp";
	document.APcl_mode.submit(); 
}
...
<form action="/goform/wiz_5in1_redirect" method="POST" name="APcl_mode">
	...
	<tr>
		<td align="center">
			...
			<table border="0" style="height:100px;" id="tablewidth" class="tablewidth0" align="center">
				<tr>
					<td align="center" class="Arial_16"><script>dw(APcl_select)</script></td>
				</tr>
			</table>
			...
			<table border="0" align="center" style="height:70px;width:780px">
				<tr>
					<td align="right" width="40%">
						<input type="radio" value="2" name="enable2g" onClick="modeswitch(2)">						
					<td align="left" width="60%" class="Arial_16">&nbsp;<script>dw(wizard_repeater_mode2)</script></td>
				</tr>

				<tr>
					<td align="right" width="40%">
						<input type="radio" value="1" name="enable5g" onClick="modeswitch(1)">					
			...
			<table border="0" style="height:220px;width:780px" align="center">
				<tr><td></td></tr>
			</table>
