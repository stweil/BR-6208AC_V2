...
function init()
{
	/*if (iqsetup_finish != 0){
		if(rep_enable5g=="1")
			document.repeater_mode.enable5g.checked = true;
		else
			document.repeater_mode.enable5g.checked = false;

		if(rep_enable2g=="1")
			document.repeater_mode.enable2g.checked = true;
		else
			document.repeater_mode.enable2g.checked = false;
	}
	else{*/
		document.repeater_mode.enable5g.checked = true;
		document.repeater_mode.enable2g.checked = true;
...
{
	// 5G
	if (document.repeater_mode.enable5g.checked == true)
		document.repeater_mode.rep_enable5g.value = "1" ;
	else
		document.repeater_mode.rep_enable5g.value = "0" ;
	
	// 2.4G
	if (document.repeater_mode.enable2g.checked == true)
	...
	<tr>
		<td align="center">
			...
			<table border="0" align="center" style="height:70px;width:780px">
				<tr>
					<td align="right" width="40%"><input type="checkbox" name="enable2g" value=""></td>
					<td align="left" width="60%" class="Arial_16">&nbsp;<script>dw(wizard_repeater_mode2)</script></td>
				</tr>
		
				<tr>
					<td align="right" width="40%"><input type="checkbox" name="enable5g" value=""></td>
