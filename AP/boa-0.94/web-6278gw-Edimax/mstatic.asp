...
function checkip(index)
{
	with(document.tcpip) 
	{
		...
		{
		case 0:
			if ( !ipRule( ip, showText(IPAddress), "ip", 1)) return false;
			else return true;
			break;
		...
		case 2:
			if ( !ipRule( gateway, showText(defaultGateway), "gw", 1)) return false;
			else if ( !ipRuleAND( ip, mask, gateway, showText(defaultGatewayWarning), "gw", 1)) return false;
			else return true;
			break;
...
<td align="center">
	...
	<table border="0" style="height:383px;width:600px" align="center">
		<tr>
		<td align="center" >
			<table border="0" class="DhcpTable0">
				<tr>
				...
				<tr>
				<td align="right" width="46%" style="font-family:Calibri,Arial,Microsoft JhengHei;font-size:16px;">
				<script>dw(IPAddress)</script>&nbsp;&nbsp;
				</td>
				<td align="left" width="54%" style="font-family:Calibri,Arial,Microsoft JhengHei;font-size:16px;">
				<input type="text" class="Arial_16" name="ip" size="15" maxlength="15" value="<% getInfo("wan-ip-rom"); %>" >
				</td>
				</tr>
				...
				<input type="text" class="Arial_16" name="mask" size="15" maxlength="15" value="<% getInfo("wan-mask-rom"); %>" >
				</td>
				</tr>
				...
				<td align="left" style="font-family:Calibri,Arial,Microsoft JhengHei;font-size:16px;">
				<input type="text" class="Arial_16" name="gateway" size="15" maxlength="15" value="<% getInfo("wan-gateway-rom"); %>" >
				</td>
				</tr>
				...
				if( wizMode != 4 )
				{
					...
					document.write('<input type="text" name="macAddr" value="<% getInfo("wanMac"); %>" size="15" maxlength="12" class="Arial_16" onchange="checkmac(this)">&nbsp;');
					document.write('<input type="button" value="'+showText(CloneMAC)+'" name="Clone" onClick="copyto();" style="font-family:Calibri,Arial,Microsoft JhengHei;font-size:16px;"></td>');
					document.write('</tr>');
				}
				else
				{
				...
				<td><input type="text" class="Arial_16" name="dns1" size="15" maxlength="15" value="<% getInfo("wan-dns1"); %>" ></td>
				</tr>
				<tr>
				<td align="right" class="text" style="font-family:Calibri,Arial,Microsoft JhengHei;font-size:16px;"><script>dw(dnsAddr2)</script>&nbsp;&nbsp;</td>
				<td><input type="text" class="Arial_16" name="dns2" size="15" maxlength="15" value="<% getInfo("wan-dns2"); %>" ></td>
				</tr>
			</table>
