...
function init()
{
	if (iqsetup_finish != 0){
	  if (wiz_wispManu==0){
	   document.WISP_mode.iq_auto.checked = true;
	   document.WISP_mode.iq_hand.checked = false;
	  }
	  else{
	   document.WISP_mode.iq_auto.checked = false;
	   document.WISP_mode.iq_hand.checked = true;
	  }
	}
	else{
	  document.WISP_mode.iq_auto.checked = true;
...
function goBack()
{
	window.location.assign("/wiz_WISP.asp");
}
function goNext()
{
	if ( document.WISP_mode.iq_auto.checked == true){
		document.WISP_mode.wiz_wispManu.value = "0"; //iQsetup by Auto
	}
	else{
		document.WISP_mode.wiz_wispManu.value = "1"; //iQsetup by hand
	}
	document.WISP_mode.submiturl.value = "/wiz_WISPselect1.asp";
...
<table border="0" style="height:600px;width:800px" align="center" background="/graphics/empty-dot.jpg">
	<tr>
		<td align="center">
			...
			<table border="0" align="center" style="height:101px;" id="tablewidth" class="tablewidth0">
			...
			<table border="0" align="center" style="height:0px;width:780px">
				<tr>
					<td align="right" width="40%"><input type="radio" value="1" name="iq_auto" onClick="modeswitch(1)">
			...
			<table border="0" align="center" style="height:0px;width:780px">
				<tr>
					<td align="right" width="40%"><input type="radio" value="0" name="iq_hand" onClick="modeswitch(2)">
