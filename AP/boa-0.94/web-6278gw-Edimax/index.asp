...
{
	lframe_total_width=1024;
	lframe_main_width=lframe_total_width-lframe_list_width;
	document.getElementById('list').style.width = lframe_list_width+"px";
	document.getElementById('main').style.width = lframe_main_width+"px";
}
</script>
...
<body bgcolor="#FFFFFF" text="#000000" onload="init()">
	<table border="0" align="center" class="pageBorder">
						...
						<form name=form>
							<select name ="site" onchange ="javascript: setlanguage()" style="width:120">
								<script>
									...
									document.write("<option name =\"SelectCZ\" value =\"7\""); //Czech Republic 捷克語
									if(stype == "7" ) document.write("selected");
									document.write(">čeština</option>");

									document.write("<option name =\"SelectPL\" value =\"8\""); //Poland
									if(stype == "8" ) document.write("selected");
									document.write(">Polski</option>");

									document.write("<option name =\"SelectRO\" value =\"9\"");  //Romania
									...
									document.write("<option name =\"SelectTW\" value =\"12\""); //Українська 烏克蘭
			...
			<tr>
				<td>
					<script>
						if((wizMode==0) || (iqsetup_finish==0))  // no finish iqsetup, use router mode
							document.write('<iframe src="left_list.asp" style="height:698px; width:190px;" marginheight="0" marginwidth="0" name="lFrame" frameborder="0" id="list"></iframe>');
						else if(wizMode==1)
							document.write('<iframe src="left_list_ap.asp" style="height:698px; width:190px;" marginheight="0" marginwidth="0" name="lFrame" frameborder="0" id="list"></iframe>');
						else if(wizMode==2)
							document.write('<iframe src="left_list_rep.asp" style="height:698px; width:190px;" marginheight="0" marginwidth="0" name="lFrame" frameborder="0" id="list"></iframe>');
						else if(wizMode==3)
							document.write('<iframe src="left_list_APcl.asp" style="height:698px; width:190px;" marginheight="0" marginwidth="0" name="lFrame" frameborder="0" id="list"></iframe>');
						else if(wizMode==4) 
							document.write('<iframe src="left_list_wisp.asp" style="height:698px; width:190px;" marginheight="0" marginwidth="0" name="lFrame" frameborder="0" id="list"></iframe>');
					</script>
				</td>
				<td>
					<script>
						if((wizMode==0) || (wizMode==4) || (iqsetup_finish==0)) // no finish iqsetup, use router mode
						  document.write('<iframe src="status.asp" style="height:698px; width:834px;" marginheight="0" marginwidth="0" name="main" id="main" scrolling="" frameborder="0"></iframe>');
						else
