...
function setTableWidth()
{
	if(isRestDefault == 1){
		...
		document.getElementById('table2width').className="table2width"+stype;
		document.getElementById('table3width').className="table2width"+stype;

		document.getElementById('table24gLwidth').className="table24gLwidth"+stype;
		document.getElementById('table24gMwidth').className="table24gMwidth"+stype;
		document.getElementById('table24gRwidth').className="table24gRwidth"+stype;

		document.getElementById('table5gLwidth').className="table24gLwidth"+stype;
		document.getElementById('table5gMwidth').className="table24gMwidth"+stype;
		document.getElementById('table5gRwidth').className="table24gRwidth"+stype;
		
		document.getElementById('table24gL1width').className="table24gLwidth"+stype;
		document.getElementById('table24gM1width').className="table24gLwidth"+stype;

		document.getElementById('table5gL1width').className="table24gLwidth"+stype;
		document.getElementById('table5gM1width').className="table24gLwidth"+stype;
	}
}
</script>
<style type="text/css">
...
<td align="center">
	...
	<span id="setupId" style="display:none">
		...
		<table border="0" style="height:0px;" align="center" id="table3width" class="table2width0">
			<tr>
				<td align="left" style="font-size:16px;font-family:Calibri,Arial,Microsoft JhengHei; line-height:25px;"><script>dw(router_last)</script>
			</tr>
		</table>
	</span>
