...
var methodVal = <%getVar("5GwdsEncrypt","","");%>;
var opMode = <%getVar("opMode","","");%>;
var APSecMode = <%getVar("5GsecMode","","");%>;
...
<p align="center">
	<br>
  <span class="tiltleText"><script>dw(apmode4)</script>&nbsp;<script>dw(SecuritySetting)</script></span>
  <!--<br>
  <br>
  ...
  <br>
	...
	<form action="/goform/formWdsEncrypt5G" method=POST name="formWdsEncrypt">
			...
			<table align="center" border="0" Cellspacing="0" width="450">
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;"><span class="choose-itemText">
						<script>
							var wpaCipher5G = <%getVar("5GwpaCipher","","");%>;
							var wdswpaCipher5G = <%getVar("5GwdsWpaCipher","","");%>;
							if(wpaCipher5G == 1)
				...
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;">
						<select size="1" name="wdsPskFormat">
							<script>	
								var wdsPskFormat = <%getVar("5GwdsPskFormat","","");%>;				
								var pskFormat = <%getVar("5GpskFormat","","");%>;
								//if(wdsPskFormat == 0)
								if(pskFormat == 0)
								{
...
<!--====================================================================== end =======================================================================-->
			...
			<table align="center" border="0" Cellspacing="0" width="450">
				<tr>
					...
					<td><div style="text-align:left; width:250px;  padding-left:1px;">
						<script>
							var wdsPskValue =	<%getInfo("5GwdsPskValue");%>;
			...
			<input type="hidden" value="/wlWDS4_key5g.asp" name="submit-url">
	</form>
