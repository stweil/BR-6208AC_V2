...
function updateFormat()
{
  ...
  else if (document.wisp_form.stadrv_weplength.selectedIndex == 1)
  {
	...
	//var type = <%getVar("staKeyType","","");%>;
  //document.wisp_form.stadrv_wepformat.options[type].selected=true;
...
function TypeSelection(connectTypemodesw)
{
	if ( connectTypemodesw.ConnectType.selectedIndex == 2)
	{
		if (pppConnectStatus==0)
		{
			connectTypemodesw.Connect.disabled=false;
			connectTypemodesw.Disconnect.disabled = true;

			connectTypemodesw.Connect.style.color='#ffffff';
			connectTypemodesw.Disconnect.style.color=disableButtonColor;
		}
		else
		{		
			connectTypemodesw.Connect.disabled=true;
			connectTypemodesw.Disconnect.disabled = false;

			connectTypemodesw.Connect.style.color=disableButtonColor;
			connectTypemodesw.Disconnect.style.color='#ffffff';
		}
			
		connectTypemodesw.IdleTime.disabled = true;
	}
	else
	{
		connectTypemodesw.Connect.disabled = true;
		...
		if (connectTypemodesw.ConnectType.selectedIndex == 1) connectTypemodesw.IdleTime.disabled=false;
		else connectTypemodesw.IdleTime.disabled=true;
	}
}

function displayUpdate(mode)
{
	if(mode==2)
	{
		with(document.ppp) {
			...
			if( wizMode != 4)
			{
				...
				{
					document.getElementById('DualAccessEnableBtId_pppoe').style.display="block";
				...
				{
					document.getElementById('DualAccessEnableBtId_pppoe').style.display="none";
					macAddr.disabled=false
					Clone.disabled=false
					Clone.style.color='#ffffff';
				}
	...
	else if(mode==3)
	{
		with(document.pptp) {
			if( wizMode != 4)
			{
				if(enableDuallAccesspptp.checked==true)
				{
					document.getElementById('DualAccessEnableBtId_pptp').style.display="block";
				}
				else
				{
					document.getElementById('DualAccessEnableBtId_pptp').style.display="none";
				}
			}
		}
	}
	else if(mode==6)
	{
		with(document.l2tp) {
			if( wizMode != 4)
			{
				if(enableDuallAccessl2tp.checked==true)
				{
					document.getElementById('DualAccessEnableBtId_l2tp').style.display="block";
				}
				else
				{
					document.getElementById('DualAccessEnableBtId_l2tp').style.display="none";
				}
			}
		}
	}	
	...
	switch(who)
	{
		...
		case 2:
			with(document.ppp) {
					...
					{
						macAddr.value="000000000000";
						macAddr2.value="000000000000";
					}
...
<blockquote>
		...
		<fieldset>
			<legend><script>dw(ConnectionMode)</script></legend>
				<form name="wantype_form">
					<table align="center" border="0" Cellspacing="4" width="700"><!-- cellspacing="0" cellpadding="0">-->
						<tr>
							<td><div class="itemText-len"><script>dw(ConnectionMode)</script></div></td>
							<td><div class="itemText2-len">
								<select name="wantype" id="wantype" onChange="switch_mode(this.value);" class="">

									<script>
										var suppoutType;
										if(wizMode==4) suppoutType=2;
										else suppoutType=6;

										var wanTbl = new Array(showText(DynamicIP), showText(StaticIP), showText(PPPoE),
																					 showText(PPTP), null, null, showText(L2TP), showText(WISP));
										for (i=0 ; i<=suppoutType ; i++)
										{
											if ( i == wanmod )
	...
	<fieldset name="dynamicip_fieldset" id="dynamicip_fieldset">
		<legend><script>dw(DynamicIP)</script></legend>
			...
			<form action=/goform/formWanTcpipSetup method=POST name="dip">
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						...
						{
							document.write('<tr>');
							document.write('<td><div class="itemText-len">'+showText(macAddr)+'</div></td>');
						...
						<tr>
							...
							<td><div class="itemText2-len">
							<script>
								if(valdns1)	document.write('<input type="text" name="dns1" value="'+valdns1+'" size="15" maxlength="30">')
						...
						<tr>
							...
							<td><div class="itemText2-len">
								<script>
									if(valdns2)	document.write('<input type="text" name="dns2" value="'+valdns2+'" size="15" maxlength="30">')
						...
						<tr>
							...
							<td><div class="itemText2-len">
								<script>
									if(valdns3)	document.write('<input type="text" name="dns3" value="'+valdns3+'" size="15" maxlength="30">')
						...
						<tr>
							...
							<td><div class="itemText2-len">
								<input type="text" name="dhcpMTU" size="10" maxlength="4" value="<% getInfo("independMTU"); %>">&nbsp;<span class="itemText">(576&lt;= <script>dw(MTU)</script>&ensp;<script>dw(Value)</script> &lt;=1500)</span>
							</div></td>
						</tr>
						<tr>
		...
		<fieldset name="staticip_fieldset" id="staticip_fieldset" style="display:none">
			<legend><script>dw(StaticIP)</script></legend>
				<form action=/goform/formWanTcpipSetup method=POST name="sip">
					...
					<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
						...
						<tr>
							<td><div class="itemText-len"><script>dw(MTU)</script></div></td>
							<td><div class="itemText2-len">
								<input type="text" name="stipMTU" size="10" maxlength="4" value="<% getInfo("independMTU"); %>">&nbsp;<span class="itemText">(576&lt;= <script>dw(MTU)</script>&ensp;<script>dw(Value)</script> &lt;=1500)</span>
							</div></td>
						</tr>
						<tr>
							<td><div class="itemText-len"><script>dw(TTL)</script></div></td>
   ...
   <!-- ===================================         PPPOE    ===================================          -->
			<fieldset name="pppoe_fieldset" id="pppoe_fieldset" style="display:none">
				<legend><script>dw(PPPoE)</script></legend>
					<form action=/goform/formWanTcpipSetup method=POST name="ppp">
							...
							<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
								...
								<tr>
									<td><div class="itemText-len"><script>dw(ConnectionType)</script></div></td>
									<td><div class="itemText2-len">
										<select size="1" name="ConnectType" onChange="TypeSelection(document.ppp);">
											<script>
											 	var type = <%getVar("pppConnectType","","");%>;
												var typeTbl = new Array(showText(Continuous), showText(ConnectonDemand), showText(Manual));
												for (i=0 ; i<3 ; i++)
												{
													if ( i == type )
										...
										<script>
											document.write('<input type="button" value="'+showText(Connect)+'" name="Connect" onClick="return saveChanges(2, 0, 0)" class="ui-button-nolimit">&nbsp;')
											document.write('<input type="button" value="'+showText(Disconnect)+'" name="Disconnect" onClick="return saveChanges(2, 0, 1)" class="ui-button-nolimit">')
										</script>
										<script>
											var ConnectStatu = <%getVar("pppConnectStatus","","");%>;
											if (ConnectStatu) setPPPConnected();
										</script>
									</div></td>
								</tr>
								<tr>
									<td><div class="itemText-len"><script>dw(IdleTimeOut)</script></div></td>
									<td><div class="itemText2-len">
										<input type="text" name="IdleTime" size="10" maxlength="4" value="<% getInfo("wan-ppp-idle"); %>">&nbsp;<span class="itemText">(1-1000 <script>dw(minutes)</script>)</span>
									</div></td>
								</tr>
								...
								<tr>
									<td colspan="2" style="text-align:left; padding-left:50px;">
										<script>
											if( wizMode != 4)
											{
												document.write('<input type="checkbox" name="enableDuallAccessppp" <%getVar("isDuallAccessEnable","1","checked");%> value="ON" onclick=displayUpdate(2);>&nbsp;<span class="itemText">'+showText(enable)+'&ensp;'+showText(DualWanAccess)+'&ensp;:</span>');
											}
										</script>
									</td>
									<td>
						...
						<div id="DualAccessEnableBtId_pppoe" style="display:none">
							<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
									<tr>
									...
									<tr>
										...
										<td><div class="itemText2-len">
											<script>
												if(!duallAccessType){
													document.write('<input type="radio" name="duallAccessMode" value="0" onClick="displayUpdate(2);" checked><span class="choose-itemText ">'+showText(DynamicIP)+'</span>')
													document.write('<input type="radio" name="duallAccessMode" value="1" onClick="displayUpdate(2);"><span class="choose-itemText ">'+showText(StaticIP)+'</span>')
												}
												else
												{	
													document.write('<input type="radio" name="duallAccessMode" value="0" onClick="displayUpdate(2);"><span class="choose-itemText ">'+showText(DynamicIP)+'</span>')
													document.write('<input type="radio" name="duallAccessMode" value="1" onClick="displayUpdate(2);" checked><span class="choose-itemText ">'+showText(StaticIP)+'</span>')
												}	
											</script>
										</div></td>
									</tr>
								...
								<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700" id="dynamicBtId" style="display:none" >
									...
									if( wizMode != 4)
									{
											...
											document.write('<td><div class="itemText-len">'+showText(macAddr)+'</div></td>');
											document.write('<td><div class="itemText2-len">');
											document.write('<input type="text" name="macAddr2" value="<% getInfo("wanMac"); %>" size="20" maxlength="12">&nbsp;');
									...
									{
										document.write('<input type=hidden value="" name="macAddr2">');
									}
									</script>
        ...
        <!-- ===================================         pptp    ===================================          -->
				<fieldset name="pptp_fieldset" id="pptp_fieldset" style="display:none">
					<legend><script>dw(PPTP)</script></legend>
						<form action="/goform/formPPTPSetup" method="POST" name="pptp">
								...
								<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
									...
									<tr>
										<td colspan="2" style="text-align:left; padding-left:50px;">
											<script>
												document.write('<input type="checkbox" name="enableDuallAccesspptp" <%getVar("isDuallAccessEnable","1","checked");%> value="ON" onclick=displayUpdate(3);>&nbsp;<span class="itemText">'+showText(enable)+'&ensp;'+showText(DualWanAccess)+'&ensp;:</span>')
											</script>
										</td>
									</tr>
								</table>

								<div id="DualAccessEnableBtId_pptp" style="display:none">
								<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
									<tr>
										<td><div class="itemText-len"><script>dw(IGMPSource)</script></div></td>
										<td><div class="itemText2-len">
								...
								<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
									...
									<tr>
										<td><div class="itemText-len"><script>dw(ConnectionType)</script></div></td>
										<td><div class="itemText2-len">
											<select size="1" name="ConnectType" onChange="TypeSelection(document.pptp);">
												<script>
												 var type = <%getVar("pptpConnectType","","");%>;
													var typeTbl = new Array(showText(Continuous), showText(ConnectonDemand), showText(Manual));
													for (i=0 ; i<3 ; i++)
													{
														if ( i == type )
											...
											<script>
												document.write('<input type="button" value="'+showText(Connect)+'" name="Connect" onClick="return saveChanges(3, 0, 0)" class="ui-button-nolimit">&nbsp;')
												document.write('<input type="button" value="'+showText(Disconnect)+'" name="Disconnect" onClick="return saveChanges(3, 0, 1)" class="ui-button-nolimit">')
											</script>
											<script>
												ConnectStatu = <%getVar("pppConnectStatus","","");%>;
												if (ConnectStatu) setPPPConnected();
											</script>
										</div></td>
									</tr>
									<tr>
										<td><div class="itemText-len"><script>dw(IdleTimeOut)</script></div></td>
										<td><div class="itemText2-len">
											<input type="text" name="IdleTime" size="10" maxlength="4" value="<% getInfo("wan-pptp-idle"); %>">&nbsp;<span class="itemText">(1-1000 <script>dw(minutes)</script>)</span>
										</div></td>
									</tr>
								</table>
      ...
      <!-- ===================================         l2tp    ===================================          -->
			<fieldset name="l2tp_fieldset" id="l2tp_fieldset" style="display:none">
				<legend><script>dw(L2TP)</script></legend>
					<form action="/goform/formL2TPSetup" method="POST" name="l2tp">
						...
						<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
							...
							<tr>
								<td colspan="2" style="text-align:left; padding-left:50px;">
									<script>
										document.write('<input type="checkbox"name="enableDuallAccessl2tp" <%getVar("isDuallAccessEnable","1","checked");%> value="ON" onclick=displayUpdate(6);>&nbsp;<span class="itemText">'+showText(enable)+'&ensp;'+showText(DualWanAccess)+'&ensp;:</span>')
									</script>
								</td>
							</tr>
						</table>

						<div id="DualAccessEnableBtId_l2tp" style="display:none">
						<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">
							<tr>
								<td><div class="itemText-len"><script>dw(IGMPSource)</script></div></td>
								<td><div class="itemText2-len">
						...
						<table align="center" border="0" Cellspacing="1" cellpadding="4" width="700">						
							...
							<tr>
								<td><div class="itemText-len"><script>dw(ConnectionType)</script></div></td>
								<td><div class="itemText2-len">
									<select size="1" name="ConnectType" onChange="TypeSelection(document.l2tp);">
										<script>
										 var type = <%getVar("L2TPConnectType","","");%>;
											var typeTbl = new Array(showText(Continuous), showText(ConnectonDemand), showText(Manual));
											for (i=0 ; i<3 ; i++)
											{
												if ( i == type )
									...
									<script>
										document.write('<input type="button" value="'+showText(Connect)+'" name="Connect" onClick="return saveChanges(6, 0, 0)" class="ui-button-nolimit">&nbsp;')
										document.write('<input type="button" value="'+showText(Disconnect)+'" name="Disconnect" onClick="return saveChanges(6, 0, 1)" class="ui-button-nolimit">')
									</script>
								</div></td>
							</tr>
							<tr>
								<td><div class="itemText-len"><script>dw(IdleTimeOut)</script></div></td>
								<td><div class="itemText2-len">
									<input type="text" name="IdleTime" size="10" maxlength="4" value="<% getInfo("L2TPIdleTime"); %>">&nbsp;<span class="itemText">(1-1000 <script>dw(minutes)</script>)</span>
								</div></td>
							</tr>
						</table>
										...
										<td><div class="itemText2-len">
											<select size="1" name="stadrv_wepformat" ONCHANGE="setDefaultKeyValue()" class="select">
												<script>
													for(i=0;i<2;i++)
													{
														if( i == <% getInfo("stadrv_wepformat1"); %> )
