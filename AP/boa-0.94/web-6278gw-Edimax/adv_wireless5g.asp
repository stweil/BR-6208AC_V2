...
var NChanWidthnode =<%getiNICVar("NChanWidth","","");%>;
				...
				<form action="/goform/formiNICAdvanceSetup"  method="POST" name="advanceSetup">
					...
					//				    band2mask = [0, 1, 4, 3, 1, 7];
									...
									<tr>
										...
										<td><div class="itemText2-len"><span class="choose-itemText ">
											<script>
												if(typeof(_ID_LAB_)!="undefined"){
													document.write(showText(MHZ20));
													document.write('<input type="hidden" name="wlanNChanWidth" value="1">');
												}	
												else{
													if(OPMODE == 3 && WIZMODE == 4)
													{
													  if(NChanWidthnode==0)
														document.write(20+" MHZ");
													  else if(NChanWidthnode==1||NChanWidthnode==2)
														document.write(40+"/"+20+" MHZ");
													  else
														document.write(80+"/"+40+"/"+20+" MHZ");
													} 
													else{     
														...
														document.write('&nbsp;<input type="radio" name="wlanNChanWidth" value="1" <%getiNICVar("NChanWidth","1","checked");%> >20 '+showText(MHZ)); 
													}
												}
												</script>
									...
									<tr>
										<td><div class="itemText-len"><span class="itemText"><script>dw(WMM)</script></span></div></td>
										<td><div class="itemText2-len"><span class="choose-itemText ">
											<script>
												...
												/*if(wmm==1)
													document.write('<input type="radio" name="wlanWmm" value="yes" checked>'+showText(Auto)+'&nbsp;&nbsp;');
												else
													document.write('<input type="radio" name="wlanWmm" value="no" checked>'+showText(Auto)+'&nbsp;&nbsp;');*/
											</script>
										</span></div></td>
									</tr>
							</table>
