								...
								<tr>
									...
									<div id="Administration_1">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list5_1" onmouseout="sub_color_change_mouseout(1,5);" onmouseover="sub_color_change_mouseover(1,5);">
											<tr>
												<td nowrap="nowrap" width="15"></td>
												<td nowrap="nowrap"><a href='admin_timezone.asp' target='main'><span class="sublist" onClick="sub_list_click(1,5,5);" id="subl-ist-Title5_1"><script>dw(TimeZone)</script></span></a></td>
											</tr>
										</table>
										<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list5_2" onmouseout="sub_color_change_mouseout(2,5);" onmouseover="sub_color_change_mouseover(2,5);">
											<tr>
												<td nowrap="nowrap" width="15"></td>
												<td nowrap="nowrap"><a href='admin_password.asp' target='main'><span class="sublist" onClick="sub_list_click(2,5,5);" id="subl-ist-Title5_2"><script>dw(Password)</script></span></a></td>
											</tr>
										</table>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list5_3" onmouseout="sub_color_change_mouseout(3,5);" onmouseover="sub_color_change_mouseover(3,5);">
											<tr>
												<td nowrap="nowrap" width="15"></td>
												<td nowrap="nowrap"><a href='admin_backrestore.asp' target='main'><span class="sublist" onClick="sub_list_click(3,5,5);" id="subl-ist-Title5_3"><script>dw(BackupRestore)</script></span></a></td>
											</tr>
										</table>
										<table width="100%" border="0" cellspacing="0" cellpadding="3" id="list5_4" onmouseout="sub_color_change_mouseout(4,5);" onmouseover="sub_color_change_mouseover(4,5);">
											<tr>
												<td nowrap="nowrap" width="15"></td>
												<td nowrap="nowrap" id="IEBrowser"><a href='admin_upgradeIE.asp' target='main'><span class="sublist" onClick="sub_list_click(4,5,5);" id="subl-ist-Title5_4"><script>dw(Upgrade)</script></span></a></td>
												<td nowrap="nowrap" id="OtherBrowser"><a href='admin_upgrade.asp' target='main'><span class="sublist" onClick="sub_list_click(4,5,5);" id="subl-ist-Title5_4"><script>dw(Upgrade)</script></span></a></td>
											</tr>
										</table>
										<table class="last_subitemBorder" width="100%" border="0" cellspacing="0" cellpadding="3" id="list5_5" onmouseout="sub_color_change_mouseout(5,5);" onmouseover="sub_color_change_mouseover(5,5);">
											<tr>
												<td nowrap="nowrap" width="15"></td>
												<td nowrap="nowrap"><a href='admin_restart.asp' target='main'><span class="sublist" onClick="sub_list_click(5,5,5);" id="subl-ist-Title5_5"><script>dw(Restart)</script></span></a></td>
											</tr>
										</table>
									</div>
						</td>
