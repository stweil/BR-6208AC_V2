...
function loadonstart() {
  ...
  <body class="" onload="loadonstart();">
    ...
    <br>
		...
		<form action=/goform/formWlSiteSurvey5G method=POST name="searching">
			<input type="hidden" value="Refresh" name="refresh">
			<input type="hidden" value="/wlsurvey5g.asp" name="submit-url">
		</form>

		<form action=/goform/formWlSiteSurvey5G method=POST name="formWlSiteSurvey">
