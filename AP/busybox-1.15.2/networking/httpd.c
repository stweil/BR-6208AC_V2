...
static void send_headers(int responseNum)
{
	...
	char tmp_str[80];
#ifdef _WanAutoDetect_
        char test_str[80] = "Fri, 15 Sep 2000 09:09:09 GMT";
#elif _IQSETUP_ 
	char test_str[80] = "Fri, 15 Sep 2000 09:09:09 GMT";
#endif
	int len;
	...
	len = sprintf(iobuf,
			...
			"Date: %s\r\nConnection: close\r\n",
#ifdef _WanAutoDetect_
                        responseNum, responseString, mime_type, test_str);
#elif _IQSETUP_
			responseNum, responseString, mime_type, test_str);	
#else
		...
		const char *content_type)
{
 ...
 error_execing_cgi:
		...
		send_cgi_and_exit("/cgi-bin/index.cgi", "GET", 500, "", "text/html");
	} /* end child */
