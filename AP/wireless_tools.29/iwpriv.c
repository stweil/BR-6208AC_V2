...
{
  struct iwreq	wrq;
// Ken patch tommy+04012016 increasing the maximum buffer size from 4K to 8K. This helps when the repeater does a scan in a busy area with lots of signals.
